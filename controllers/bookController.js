...
module.exports = {
  // Get all entries from the Book collection
  ...
  // Get a entry from the Book collection with the matching
  ...
  // Create a new entry in the Book collection
  ...
  // Remove an entry from the Book collection
